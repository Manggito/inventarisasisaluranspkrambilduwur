...
var style_BANGUNANNOMEKLATUR_11 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var offsetY = 0;
    var placement = 'point';
    if (exp_label_BANGUNANNOMEKLATUR_11_eval_expression(context) !== null) {
        labelText = String(exp_label_BANGUNANNOMEKLATUR_11_eval_expression(context));
    }
